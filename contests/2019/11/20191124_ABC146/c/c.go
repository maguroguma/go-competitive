...
func main() {
	...
	isOK := func(m int) bool {
		digit := DigitNumOfDecimal(m)
		// if IsProductOverflow(a, m, INF_INT64) {
		// 	return false
		// }
		// if IsProductOverflow(b, digit, INF_INT64) {
		// 	return false
		// }
		// if IsAddOverflow(a*m, b*digit, INF_INT64) {
		// 	return false
		// }
...
func IsProductOverflow(i, j, m int) bool {
	return float64(i)*float64(j) > float64(m)
}

func IsAddOverflow(i, j, m int) bool {
	return float64(i)+float64(j) > float64(m)
}
