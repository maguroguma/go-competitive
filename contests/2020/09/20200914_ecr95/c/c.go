...
func solve() {
	...
	for i := 0; i < n; i++ {
		if A[i] == 0 {
			// フレンド
			ChMin(&dp[i+1][0][1], dp[i][0][0])
			ChMin(&dp[i+1][1][0], dp[i][0][0])
			ChMin(&dp[i+1][1][0], dp[i][0][1])

			// 自分
			ChMin(&dp[i+1][1][1], dp[i][1][0])
			ChMin(&dp[i+1][0][0], dp[i][1][0])
			ChMin(&dp[i+1][0][0], dp[i][1][1])
		} else {
			// フレンド
			ChMin(&dp[i+1][0][1], dp[i][0][0]+1)
			ChMin(&dp[i+1][1][0], dp[i][0][0]+1)
			ChMin(&dp[i+1][1][0], dp[i][0][1]+1)
