...
func main() {
	...
	e := func() S { return S{INF_B30} }
	merger := func(a, b S) S { return a }
	const CM = -INF_B30
	...
	id := func() F { return F{CM} }
	colSeg := NewLazySegtree(colV, e, merger, mapper, composer, id)
	rowSeg := NewLazySegtree(rowV, e, merger, mapper, composer, id)
