...
func main() {
	...
	PrintDebug("before build...\n")
	for i := 0; i < n; i++ {
		t := lst.Get(i)
		PrintDebug("%d: v: %d, l: %d, r: %d\n", i, t.v, t.l, t.r)
	}

	lst.Build()

	PrintDebug("before queries...\n")
	for i := 0; i < n; i++ {
		t := lst.Get(i)
		PrintDebug("%d: v: %d, l: %d, r: %d\n", i, t.v, t.l, t.r)
	}
	...
	PrintDebug("after queries...\n")
	for i := 0; i < n; i++ {
		t := lst.Get(i)
		PrintDebug("%d: v: %d, l: %d, r: %d\n", i, t.v, t.l, t.r)
	}

	PrintDebug("read raw segment tree node\n")
	for i := 0; i < n; i++ {
		t := lst.data[i+lst.sz-1]
		PrintDebug("%d: v: %d, l: %d, r: %d\n", i, t.v, t.l, t.r)
	}
}
