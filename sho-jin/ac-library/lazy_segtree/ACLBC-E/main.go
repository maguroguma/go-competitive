...
var (
	...
	D [200000 + 50]int     // 10^i
	R [200000 + 50][10]int // repeat of d
)
...
func main() {
	...
	e := func() S {
		return S{length: 0, r: 0}
	}
	merger := func(a, b S) S {
		l := a.length + b.length
		r := (a.r*D[b.length] + b.r) % MOD
		return S{length: l, r: r}
	}
...
func NewLazySegtree(v []S, e E, merger Merger, mapper Mapper, comp Composer, id Id) *LazySegtree {
