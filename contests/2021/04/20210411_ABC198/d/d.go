...
func main() {
	...
	debugf("string(numbers): %v\n", string(numbers))
	patterns := PermutationPatterns(numbers, len(R))
	// for i := 0; i < 10; i++ {
	// 	debugf("string(patterns[i]): %v\n", string(patterns[i]))
	// }
	for _, pat := range patterns {
		...
		// y, _ := strconv.Atoi(string(Y))
		// z, _ := strconv.Atoi(string(Z))
...
// PermutationPatterns returns all patterns of nPk of elems([]rune).
func PermutationPatterns(elems []rune, k int) [][]rune {
